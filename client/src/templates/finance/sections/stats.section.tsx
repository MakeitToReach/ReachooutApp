...
export const FStatsSection = ({
    ...
    return (
        <section id="stats" className="w-full sm:h-[55vh] min-h-fit flex flex-col items-center justify-center bg-template-secondary rounded-lg overflow-hidden relative py-16 px-4">
            {/* Content container */}
