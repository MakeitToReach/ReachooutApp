...
export const FBlogsSection = ({ heading, blogs }: F_BLOGS_SECTION) => {
    return (
        <section id="blogs" className="w-full rounded-lg min-h-[75vh] overflow-hidden my-14 py-4">
            <div className="max-w-6xl mx-auto h-full my-10 space-y-8 overflow-x-visible ">
                <h2 className="text-center font-semibold sm:text-5xl text-3xl tracking-tight text-template-text-primary">
                    {heading}
                </h2>
