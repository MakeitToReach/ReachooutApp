          ...
          <AccordionContent>
            <div className="space-y-3 pt-2">
              <ReqInput
                ...
                onChange={(e) =>
                  handleStatChange(0, "statNumber", e.target.value)
                }
              />

              <IconPicker
                value={stats[0]?.statIcon || "ArrowUpRight"}
                onChange={(icon) => handleStatChange(0, "statIcon", icon)}
              />
              ...
              <ReqInput
                ...
                onChange={(e) =>
                  handleStatChange(0, "statText", e.target.value)
                }
              />
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleStatChange(0, "statDescription", e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <AccordionContent>
            <div className="space-y-3 pt-2">
              <ReqInput
                ...
                onChange={(e) =>
                  handleStatChange(1, "statNumber", e.target.value)
                }
              />

              <IconPicker
                value={stats[1]?.statIcon || "ArrowUpRight"}
                onChange={(icon) => handleStatChange(1, "statIcon", icon)}
              />
              ...
              <ReqInput
                ...
                onChange={(e) =>
                  handleStatChange(1, "statText", e.target.value)
                }
              />
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleStatChange(1, "statDescription", e.target.value)
                  }
                />
              </div>
            </div>
