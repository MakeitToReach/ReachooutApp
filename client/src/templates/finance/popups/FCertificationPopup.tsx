...
export function FAddCertificationPopup({ children, onAdd }: FAddCertificationPopupProps) {
                ...
                <div className="flex flex-col gap-3">
                    <div className="space-y-2">
                        ...
                        <ImageInput
                            ...
                            onImageRemove={() => setCertification({ ...certification, imgUrl: "" })}
                        />
                    </div>
                    <ReqInput
                        type="text"
            ...
            >
                <DialogHeader>
                    <DialogTitle className="sm:text-2xl">
                        Edit Certification {certificationIdx !== undefined && `#${certificationIdx + 1}`}
                    </DialogTitle>
                </DialogHeader>
