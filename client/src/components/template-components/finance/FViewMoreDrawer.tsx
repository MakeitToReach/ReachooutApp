...
import { FIosDialog } from "./FIosDialog";
...
export const FViewMoreDrawer = ({
  ...
  return isIos ? (
    <FIosDialog content={content} type={type}>
      {children}
    </FIosDialog>
  ) : (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="sm:px-8 max-w-full theme-wrapper bg-template-primary sm:max-w-7xl mx-auto sm:min-h-[95vh] min-h-[90vh] max-h- flex flex-col">
        {/* Header */}
