...
interface ViewMoreDrawerProps {
  ...
  content: PF_PROJECT | PF_TEAM_MEMBER | PF_BLOG | PF_CATALOG | string;
...
export const ViewMoreDrawer = ({
  ...
  const about = type === "About" ? (content as string) : null;

    const videoId = getYouTubeVideoId(project?.vidUrl || catalogService?.vidUrl || "");
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="p-0 max-w-full theme-wrapper bg-template-primary sm:max-w-4xl mx-auto min-h-[100vh] flex flex-col">
        {/* Header */}
