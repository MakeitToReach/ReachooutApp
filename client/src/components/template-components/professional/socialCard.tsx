...
export const PFSocialCard = ({ title, followerCounts, btnLink }: PF_SOCIAL) => {
  ...
  return (
    <div className="w-full p-6 bg-template-primary rounded-sm flex items-center gap-6">
      ...
      <div className="flex flex-col gap-3 text-template-text-primary">
        ...
        <a href={btnLink}>
          <Button className="rounded-sm text-base bg-template-btn text-template-text-btn hover:bg-template-btn cursor-pointer">
            Check now
            <span>
