              ...
              <div key={i} className="flex flex-col gap-2">
                {field.type === "textarea" && (
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      value={data?.sections[idx].data[field.fieldPath]}
                      onChange={(e) =>
                        setSectionField(
                          section,
                          field.fieldPath,
                ...
                {field.type === "text" && (
                  <ReqInput
                    ...
                    value={data?.sections[idx].data[field.fieldPath]}
                    onChange={(e) =>
                      setSectionField(section, field.fieldPath, e.target.value)
                    }
                  />
                )}
                ...
                {field.type === "image" && (
                  ...
                  >
                    <ImageSelectButton
                      selectedImgUrl={data?.sections[idx].data[field.fieldPath]}
                    />
                ...
                {field.type === "component" &&
                  field.component?.({
                    value: data?.sections[idx].data[field.fieldPath],
                    onChange: (val: any) =>//eslint-disable-line
